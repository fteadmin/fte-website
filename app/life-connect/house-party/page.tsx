...
export default function HousePartyPage() {
  return (
    <>
      <BusinessPage
        name="House Party"
        description="House Party is the vibrant social engine behind Sage Hospitality and Lifestyle Concierge, blending real estate expertise with community engagement. We transform residential and commercial property experiences into meaningful connections through curated gatherings that make real estate personal and community-centered."
